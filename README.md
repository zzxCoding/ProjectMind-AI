...
- **v2.2** (2025-09-22) - 新增SQL项目扫描器，支持多数据库SQL文件AI异常检测，自定义AI模型配置
- **v2.1** (2025-09) - 新增GitLab MR自动审查系统，集成SonarQube和AI智能审查
- **v2.0** (2025-09) - 重构版本，新增SonarQube分析和AI增强功能
- **v1.0** (2025-09) - 初始版本，基础数据分析和自动化功能
